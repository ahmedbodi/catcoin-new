...
void SetupServerArgs(NodeContext& node)
{
    ...
    const auto testnet1ChainParams = CreateChainParams(argsman, CBaseChainParams::TESTNET1);
    const auto testnet2ChainParams = CreateChainParams(argsman, CBaseChainParams::TESTNET2);
    const auto testnet3ChainParams = CreateChainParams(argsman, CBaseChainParams::TESTNET3);
    const auto testnet4ChainParams = CreateChainParams(argsman, CBaseChainParams::TESTNET4);
    const auto testnet5ChainParams = CreateChainParams(argsman, CBaseChainParams::TESTNET5);
...
#endif
    argsman.AddArg("-assumevalid=<hex>", strprintf("If this block is in the chain assume that it and its ancestors are valid and potentially skip their script verification (0 to verify all, default: %s, testnet1: %s, testnet2: %s, testnet3: %s, testnet4: %s, testnet5: %s, signet: %s)", defaultChainParams->GetConsensus().defaultAssumeValid.GetHex(), testnet1ChainParams->GetConsensus().defaultAssumeValid.GetHex(), testnet2ChainParams->GetConsensus().defaultAssumeValid.GetHex(), testnet3ChainParams->GetConsensus().defaultAssumeValid.GetHex(), testnet4ChainParams->GetConsensus().defaultAssumeValid.GetHex(), testnet5ChainParams->GetConsensus().defaultAssumeValid.GetHex(), signetChainParams->GetConsensus().defaultAssumeValid.GetHex()), ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    ...
    argsman.AddArg("-minimumchainwork=<hex>", strprintf("Minimum work assumed to exist on a valid chain in hex (default: %s, testnet1: %s, testnet2: %s, testnet3: %s, testnet4: %s, testnet5: %s, signet: %s)", defaultChainParams->GetConsensus().nMinimumChainWork.GetHex(), testnet1ChainParams->GetConsensus().nMinimumChainWork.GetHex(), testnet2ChainParams->GetConsensus().nMinimumChainWork.GetHex(), testnet3ChainParams->GetConsensus().nMinimumChainWork.GetHex(), testnet4ChainParams->GetConsensus().nMinimumChainWork.GetHex(), testnet5ChainParams->GetConsensus().nMinimumChainWork.GetHex(), signetChainParams->GetConsensus().nMinimumChainWork.GetHex()), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::OPTIONS);
    ...
    argsman.AddArg("-bind=<addr>[:<port>][=onion]", strprintf("Bind to given address and always listen on it (default: 0.0.0.0). Use [host]:port notation for IPv6. Append =onion to tag any incoming connections to that address and port as incoming Tor connections (default: 127.0.0.1:%u=onion, testnet1: 127.0.0.1:%u=onion, testnet2: 127.0.0.1:%u=onion, testnet3: 127.0.0.1:%u=onion, testnet4: 127.0.0.1:%u=onion, testnet5: 127.0.0.1:%u=onion, signet: 127.0.0.1:%u=onion, regtest: 127.0.0.1:%u=onion)", defaultBaseParams->OnionServiceTargetPort(), testnet1BaseParams->OnionServiceTargetPort(), testnet2BaseParams->OnionServiceTargetPort(), testnet3BaseParams->OnionServiceTargetPort(), testnet4BaseParams->OnionServiceTargetPort(), testnet5BaseParams->OnionServiceTargetPort(), signetBaseParams->OnionServiceTargetPort(), regtestBaseParams->OnionServiceTargetPort()), ArgsManager::ALLOW_ANY | ArgsManager::NETWORK_ONLY, OptionsCategory::CONNECTION);
    ...
    argsman.AddArg("-port=<port>", strprintf("Listen for connections on <port>. Nodes not using the default ports (default: %u, testnet1: %u, testnet2: %u, testnet3: %u, testnet4: %u, testnet5: %u, signet: %u, regtest: %u) are unlikely to get incoming connections.", defaultChainParams->GetDefaultPort(), testnet1ChainParams->GetDefaultPort(), testnet2ChainParams->GetDefaultPort(), testnet3ChainParams->GetDefaultPort(), testnet4ChainParams->GetDefaultPort(), testnet5ChainParams->GetDefaultPort(), signetChainParams->GetDefaultPort(), regtestChainParams->GetDefaultPort()), ArgsManager::ALLOW_ANY | ArgsManager::NETWORK_ONLY, OptionsCategory::CONNECTION);
    ...
    argsman.AddArg("-acceptnonstdtxn", strprintf("Relay and mine \"non-standard\" transactions (%stestnet1: %u, testnet2: %u, testnet3: %u, testnet4: %u, testnet5: %u)", "testnet/regtest only; ", !testnet1ChainParams->RequireStandard(), !testnet2ChainParams->RequireStandard(), !testnet3ChainParams->RequireStandard(), !testnet4ChainParams->RequireStandard(), !testnet5ChainParams->RequireStandard()), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::NODE_RELAY);
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ahmedbodi/catcoin>";
