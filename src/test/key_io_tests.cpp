...
BOOST_AUTO_TEST_CASE(key_io_invalid)
{
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        for (const auto& chain : { CBaseChainParams::MAIN, CBaseChainParams::TESTNET1, CBaseChainParams::TESTNET2, CBaseChainParams::TESTNET3, CBaseChainParams::TESTNET4, CBaseChainParams::TESTNET5, CBaseChainParams::REGTEST }) {
            SelectParams(chain);
            destination = DecodeDestination(exp_base58string);
