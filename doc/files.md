...
`-chain=testnet1` or `-testnet1`| *path_to_datadir*`/testnet1/`
`-chain=testnet2` or `-testnet2`| *path_to_datadir*`/testnet2/`
`-chain=testnet3` or `-testnet3`| *path_to_datadir*`/testnet3/`
