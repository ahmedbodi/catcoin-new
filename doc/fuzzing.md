...
with certain assembly code from Catcoin Core's code. See [developer notes on sanitizers](https://github.com/litecoin-project/litecoin/blob/master/doc/developer-notes.md#sanitizers)
